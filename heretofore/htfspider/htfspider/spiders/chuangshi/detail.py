...
class ChuangshiDetailSpider(RedisSpider):
    name = 'chuangshi_detail'
    redis_key = 'chuangshi:detail'
    ...
    def parse(self, response):
        ...
        item['book_status'] = (u'完结' in response.xpath('//div[@id="novelInfo"]//span[@class="red2"]/text()').extract()[
            0]) * 1
